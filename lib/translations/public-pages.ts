const publicPages = {
    tr: {
        ...
        landing: {
            heroAlternativeTitle: "Ürünlerinizi dakikalar içinde şık bir dijital kataloğa dönüştürün.",
            heroFeature1Start: "Tasarımını Seç, Özelleştir:",
            heroFeature1End: " Markanı en iyi yansıtan profesyonel görünümü yakala.",
            heroFeature2Start: "Zaman Kazan:",
            heroFeature2End: " Ürünlerini yapay zeka veya Excel ile saniyeler içinde aktar.",
            heroFeature3Start: "Herkese Ulaş:",
            heroFeature3End: " Kataloğunu QR, Link veya PDF ile saniyeler içinde paylaş.",
            heroFeature4Start: "Hemen Satışa Başla:",
            heroFeature4End: " Ürünlerinize eklenebilir linkler sayesinde doğrudan kataloğunuzdan sipariş alın.",
            heroStartCreating: "Ücretsiz Kataloğunu Oluştur",
            heroMockupCaption: "Özel şablonlarla ürün katalogları",
    ...
    en: {
        ...
        landing: {
            heroAlternativeTitle: "Turn your products into a stylish digital catalog in minutes.",
            heroFeature1Start: "Choose & Customize:",
            heroFeature1End: " Capture the professional look that best reflects your brand.",
            heroFeature2Start: "Save Time:",
            heroFeature2End: " Import your products in seconds via AI or Excel.",
            heroFeature3Start: "Reach Everyone:",
            heroFeature3End: " Share your catalog instantly via QR code, link, or PDF.",
            heroFeature4Start: "Start Selling:",
            heroFeature4End: " Add links to your products and receive instant orders.",
            heroStartCreating: "Create Your Free Catalog",
            heroMockupCaption: "Product catalogs with custom templates",
