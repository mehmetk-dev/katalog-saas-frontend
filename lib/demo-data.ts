...
export const DEMO_DATA: Record<string, Product[]> = {
    ...
    tech: [
        ...
        createProduct("t6", "Taşınabilir SSD", "Yüksek hızlı veri aktarımı, 1TB kapasite.", 3200, "Depolama", "https://images.unsplash.com/photo-1577538926210-fc6cc624fde2?auto=format&fit=crop&q=80&w=800", 5, "TEK-006"),
    ],
    cosmetic: [
    ...
    home: [
        createProduct("h1", "Seramik Vazo", "El yapımı, minimalist tasarım dekoratif obje.", 540, "Dekorasyon", "https://images.unsplash.com/photo-1612196808214-b8e1d6145a8c?auto=format&fit=crop&q=80&w=800", 0, "EV-001"),
        ...
        createProduct("h4", "Örgü Battaniye", "El örgüsü görünümlü, sıcak tutan şık örtü.", 950, "Tekstil", "https://plus.unsplash.com/premium_photo-1672868761629-5fc2008539f4?auto=format&fit=crop&q=80&w=800", 3, "EV-004"),
    ...
    furniture: [
        ...
        createProduct("fur2", "Mermer Sehpa", "Doğal mermer tablalı, pirinç ayaklı tasarım.", 3200, "Masa", "https://images.unsplash.com/photo-1599620400219-4bbb6325f6ff?auto=format&fit=crop&q=80&w=800", 1, "MOB-002"),
        ...
        createProduct("fur6", "Yatak Başlığı", "Döşemeli, modern kapitone detaylar.", 3600, "Yatak Odası", "https://plus.unsplash.com/premium_photo-1678790909042-daaceb35933d?auto=format&fit=crop&q=80&w=800", 5, "MOB-006"),
    ],
    automotive: [
        createProduct("a1", "Bagaj Organizer", "Katlanabilir, dayanıklı bagaj düzenleyici.", 1250, "Aksesuar", "https://images.unsplash.com/photo-1758986264687-fb767b9bb65a?auto=format&fit=crop&q=80&w=800", 0, "OTO-001"),
        createProduct("a2", "Telefon Tutucu", "Vakumlu, güvenli sürüş desteği.", 380, "Aksesuar", "https://images.unsplash.com/photo-1604837394598-5b700b11f5e4?auto=format&fit=crop&q=80&w=800", 1, "OTO-002"),
        createProduct("a3", "Paspas Seti", "Kauçuk, kolay temizlenen set.", 850, "Aksesuar", "https://plus.unsplash.com/premium_photo-1661494244080-00d15ad150ca?auto=format&fit=crop&q=80&w=800", 2, "OTO-003"),
        createProduct("a4", "Araç İçi Süpürge", "Kablosuz, kompakt ve güçlü emiş.", 1850, "Elektronik", "https://images.unsplash.com/photo-1645967184165-86a2bf2202ef?auto=format&fit=crop&q=80&w=800", 3, "OTO-004"),
        createProduct("a5", "Akü Takviye Cihazı", "Yüksek kapasiteli, powerbank özellikli.", 2950, "Aksesuar", "https://images.unsplash.com/photo-1619642751034-765dfdf7c58e?auto=format&fit=crop&q=80&w=800", 4, "OTO-005"),
        createProduct("a6", "Lastik Pompası", "Dijital göstergeli kompakt pompa.", 1100, "Elektronik", "https://plus.unsplash.com/premium_photo-1764253932310-3a5d9d7cb86b?auto=format&fit=crop&q=80&w=800", 5, "OTO-006"),
    ],
    sports: [
        ...
        createProduct("s3", "Dambıl Seti", "Ayarlanabilir ağırlık, kauçuk kaplama.", 1850, "Fitness", "https://images.unsplash.com/photo-1638536532686-d610adfc8e5c?auto=format&fit=crop&q=80&w=800", 2, "SPR-003"),
        createProduct("s4", "Kamp Sırt Çantası", "Ergonomik askılar, 50L geniş kapasite.", 2100, "Outdoor", "https://images.unsplash.com/photo-1476979735039-2fdea9e9e407?auto=format&fit=crop&q=80&w=800", 3, "SPR-004"),
        createProduct("s5", "Termos Şişe", "24 saat soğuk tutma etkili çelik yapı.", 640, "Outdoor", "https://images.unsplash.com/photo-1610399809302-f1dd7ec33187?auto=format&fit=crop&q=80&w=800", 4, "SPR-005"),
    ...
    toys: [
        createProduct("toy1", "Lego Seti", "Yaratıcılığı geliştiren 1000 parça yapı seti.", 1600, "Eğitici", "https://images.unsplash.com/photo-1587654780291-39c9404d746b?auto=format&fit=crop&q=80&w=800", 0, "OYU-001"),
        ...
        createProduct("toy3", "Uzaktan Kumandalı Araba", "Yüksek hız, arazi sürüşüne uygun.", 1250, "Hobi", "https://images.unsplash.com/photo-1769244444909-f75895a22aed?auto=format&fit=crop&q=80&w=800", 2, "OYU-003"),
        createProduct("toy4", "Oyuncak Bebek Evi", "Detaylı mobilyalarla ahşap konak.", 2400, "Hobi", "https://images.unsplash.com/photo-1645354730199-2ff21d0f874c?auto=format&fit=crop&q=80&w=800", 3, "OYU-004"),
        createProduct("toy5", "Peluş Ayıcık", "Yumuşak dolgulu, uyku arkadaşı.", 380, "Bebek", "https://plus.unsplash.com/premium_photo-1725075087153-610264ca9cbd?auto=format&fit=crop&q=80&w=800", 4, "OYU-005"),
        createProduct("toy6", "3D Puzzle", "Dünya simgeleriyle eğlenceli yapboz.", 520, "Eğitici", "https://images.unsplash.com/photo-1611546191222-96fb7afd5af9?auto=format&fit=crop&q=80&w=800", 5, "OYU-006"),
    ],
    books: [
        createProduct("b1", "Dolma Kalem", "Altın uçlu, özel kutulu imza serisi.", 1850, "Kırtasiye", "https://images.unsplash.com/photo-1518674660708-0e2c0473e68e?auto=format&fit=crop&q=80&w=800", 0, "KIR-001"),
        createProduct("b2", "Deri Ajanda", "Tarihsiz, fildişi kağıt lüks defter.", 420, "Kırtasiye", "https://images.unsplash.com/photo-1768511562691-571cbede6cc7?auto=format&fit=crop&q=80&w=800", 1, "KIR-002"),
        ...
        createProduct("b4", "Okuma Lambası", "Göz yormayan ışık, retro tasarım.", 850, "Aydınlatma", "https://plus.unsplash.com/premium_photo-1681822621402-1e5243447c97?auto=format&fit=crop&q=80&w=800", 3, "KIR-004"),
        ...
        createProduct("b6", "Sanat Kitabı", "Dünya müzeleri koleksiyonu, büyük boy.", 1100, "Kitap", "https://images.unsplash.com/photo-1761933296192-d84d3a76053b?auto=format&fit=crop&q=80&w=800", 5, "KIR-006"),
    ],
    food: [
        ...
        createProduct("fo2", "Soğuk Sıkım Zeytinyağı", "Ege bahçelerinden erken hasat.", 980, "Mutfak", "https://images.unsplash.com/photo-1627894005682-166e8687356a?auto=format&fit=crop&q=80&w=800", 1, "GID-002"),
        createProduct("fo3", "Organik Bal", "Yüksek yayla çiçeği süzme bal.", 720, "Mutfak", "https://plus.unsplash.com/premium_photo-1663957861996-8093b48a22e6?auto=format&fit=crop&q=80&w=800", 2, "GID-003"),
        createProduct("fo4", "Bitki Çayı Seti", "Özel harman rüstik çay koleksiyonu.", 380, "İçecek", "https://plus.unsplash.com/premium_photo-1730833404181-615e345ede19?auto=format&fit=crop&q=80&w=800", 3, "GID-004"),
        createProduct("fo5", "Baharat Kutusu", "8 farklı dünya baharatlı gurme set.", 560, "Mutfak", "https://plus.unsplash.com/premium_photo-1692776206795-60a58a4dc817?auto=format&fit=crop&q=80&w=800", 4, "GID-005"),
        createProduct("fo6", "El Yapımı Çikolata", "Belçika kakaolu, fındıklı trüf seti.", 680, "Gurme", "https://images.unsplash.com/photo-1610230285329-a8f410716d3e?auto=format&fit=crop&q=80&w=800", 5, "GID-006"),
    ]
}
