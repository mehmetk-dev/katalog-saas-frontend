...
export function buildIdentityResponse(language: Language, _profile?: CatalogProfile | null): ParsedAiResponse {
    if (language === "tr") {
        return {
            ...
            assistantMessage: [
                ...
                "",
                "📊 Toplu düzenleme — fiyat, stok, SKU, kategori, açıklama, çeviri ve yuvarlama",
                "✍️ İçerik üretimi — açıklama yaz/zenginleştir, isimleri düzelt, boş alanları doldur",
                "🆕 Yeni ürün önerisi — '5 kahve ürünü oluştur' gibi komutlarla onaylanabilir ürünler hazırla",
                "🧹 Alan temizleme — açıklama gibi desteklenen alanları topluca boşalt",
                "➕ Metin ekleme — ürün adlarının veya açıklamaların başına ya da sonuna metin ekle",
                "💰 Ortalama fiyat — eksik fiyatları genel veya kategori ortalamasıyla tamamla",
    ...
    return {
        ...
        assistantMessage: [
            ...
            "",
            "📊 Bulk editing — price, stock, SKU, category, descriptions, translation, and rounding",
            "✍️ Content — write/enrich descriptions, fix names, fill blanks",
            "🆕 New product suggestions — prepare reviewable products with commands such as 'create 5 coffee products'",
            "🧹 Field clearing — clear supported fields such as descriptions in bulk",
            "➕ Text insertion — prepend or append text to product names and descriptions",
            "💰 Average pricing — fill missing prices from the overall or category average",
