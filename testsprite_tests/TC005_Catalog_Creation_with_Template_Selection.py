...
async def run_test():
    ...
    try:
        ...
        # -> Fill email and password fields, then click the 'Giriş Yap' (Login) button to authenticate.
        ...
        # -> Click the 'Katalog Oluştur' (New Catalog) button on the dashboard to begin creating a catalog.
        frame = context.pages[-1]
        # Click element
        ...
        # -> Open the 'Tasarım Ayarları' (Design Settings) tab in the builder to reveal template options so a template can be selected.
        frame = context.pages[-1]
        # Click element
        ...
        # -> Confirm the catalog creation and verify it is editable by opening the editor (click the 'Düzenle' button). After that, verify editor is accessible.
        frame = context.pages[-1]
        # Click element
