...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email and password fields with the invalid test credentials and click the 'Giriş Yap' button to attempt login, then verify an error message appears.
