            ...
            <main className="pt-40 pb-32 px-4">
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className="relative mb-20">
                        <div className={cn(
                            "absolute -top-10 left-0 text-[120px] font-black",
                            "text-slate-50 select-none leading-none -z-10"
                        )}>
                            ETK
                        </div>
                        <div className={cn(
                            "inline-block px-3 py-1 bg-indigo-600 text-white",
                            "text-[10px] font-bold tracking-[0.3em] uppercase mb-6"
                        )}>
                            Legal Document
                        </div>
                        <h1 className={cn(
                            "text-5xl md:text-7xl font-black tracking-tighter",
                            "text-slate-950 mb-6 uppercase"
                        )}>
                            Ticari Elektronik <br />
                            İleti Onay Metni
                        </h1>
                        <p className={cn(
                            "text-slate-500 text-xl font-light max-w-2xl",
                            "border-l-2 border-indigo-600 pl-6"
                        )}>
                    ...
                    <div className="grid lg:grid-cols-12 gap-12 items-start">
                        ...
                        <div className="lg:col-span-7 space-y-12">
                            <section className="relative">
                                ...
                                <p className="text-lg text-slate-700 leading-relaxed font-medium">
                                    Hukuki ünvanı{" "}
                                    <span className="text-slate-950 font-bold">Burcu Aldığ</span>{" "}
                                    olan (işbu metinde &quot;FogCatalog&quot; veya &quot;Şirket&quot;
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                {[
                                    ...
                                    <div key={i} className={cn(
                                        "p-6 rounded-2xl border border-slate-100 bg-slate-50/50",
                                        ...
                                        <span className={cn(
                                            ...
                                            "text-slate-500 group-hover:text-slate-900 transition-colors"
                                        )}>
                                            {channel.label}
                                        </span>
                                    </div>
                            ...
                            <div className="pt-8 border-t border-slate-100 flex flex-col sm:flex-row items-center gap-6">
                                ...
                                <div>
                                    <h4 className={cn(
                                        "text-xl font-bold text-slate-900 mb-1 italic",
                                        "uppercase tracking-tighter underline",
                                        "decoration-indigo-500 decoration-4 underline-offset-4"
                                    )}>
                        ...
                        <div className="lg:col-span-5">
                            <div className={cn(
                                "bg-slate-950 text-white p-10 rounded-[2.5rem]",
                                "relative overflow-hidden shadow-2xl shadow-indigo-200"
                            )}>
                                <div className={cn(
                                    "absolute top-0 right-0 w-40 h-40 bg-indigo-600/30",
                                    "rounded-full blur-[80px] -translate-y-1/2 translate-x-1/2"
                                )} />
                                <h4 className={cn(
                                    "text-[10px] font-black uppercase",
                                    "tracking-[0.3em] text-indigo-400 mb-8"
                                )}>
                                    Bilgilendirme
                                </h4>
                                ...
                                <ul className="space-y-8 relative z-10">
                                    ...
                                    <li className="flex gap-4">
                                        ...
                                        <p className="text-sm text-slate-300 leading-relaxed">
                                            ...
                                            kullanabilir veya doğrudan{" "}
                                            <a
                                                href="mailto:info@fogcatalog.com"
                                                className="text-white font-bold underline decoration-indigo-500"
                                            >
                                                info@fogcatalog.com
                                            </a>{" "}
