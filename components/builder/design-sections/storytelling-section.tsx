                            ...
                            <div className="space-y-4 pt-4 border-t border-slate-100 dark:border-slate-800 animate-in fade-in slide-in-from-top-2 duration-500">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="space-y-3">
                                            {coverImageUrl ? (
                                                <div className="group relative w-full h-48 rounded-3xl overflow-hidden border-2 border-slate-100 dark:border-slate-800 shadow-sm bg-slate-50 dark:bg-slate-900/50 transition-all duration-300 hover:shadow-md">
                                                    <NextImage src={coverImageUrl} alt="Cover" fill className="object-contain transition-transform duration-500 group-hover:scale-105" unoptimized />
                                                ...
                                                <button
                                                    type="button"
                                                    onClick={() => coverInputRef.current?.click()}
                                                    className="w-full h-32 rounded-3xl border-2 border-dashed border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/30 hover:bg-slate-50 dark:hover:bg-slate-900/50 hover:border-indigo-300 dark:hover:border-indigo-900 transition-all duration-300 flex items-center justify-center gap-4 group"
                                                >
                                                    <div className="w-10 h-10 rounded-xl bg-white dark:bg-slate-800 shadow-sm border border-slate-100 dark:border-slate-700 flex items-center justify-center group-hover:scale-110 group-hover:bg-indigo-50 transition-all duration-300">
                                                        <ImageIcon className="w-5 h-5 text-slate-400 group-hover:text-indigo-500" />
                                                    </div>
                                                    <div className="text-left">
                                                        <span className="block text-[11px] font-black uppercase tracking-widest text-slate-500 group-hover:text-slate-700">Görsel Seç</span>
                                    ...
                                    <div className="space-y-2 h-full flex flex-col">
                                        <Label className="text-[10px] font-black uppercase text-slate-500 tracking-widest px-1">Kapak Açıklaması</Label>
                                        <div className="flex-1 relative">
                                            <textarea
                                                ...
                                                maxLength={500}
                                                className="w-full h-full min-h-[128px] p-4 text-sm bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all outline-none resize-none"
                                            />
                                            <p className="absolute bottom-3 right-3 text-[9px] text-slate-400 pointer-events-none bg-white/50 px-1 rounded">{(coverDescription || '').length}/500</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
